...
public class DataReader {
    ...
    public List<Vehicle> loadVehicles(String filePath) {
        ...
        // If a specific file format for vehicles is provided later, this method can be
        // updated.
        return vehicles;
    }
            ...
            while ((line = br.readLine()) != null && (maxOrders <= 0 || ordersLoaded < maxOrders)) {
                ...
                if (matcher.matches()) {
                    try {
                        ...
                        // Let's assume startDate already has the correct year and month for parsing
                        // ##d.
                        // This part needs refinement based on how year/month are determined for orders.
                        // For now, we'll construct LocalDateTime using startDate's year/month and
                        // parsed day.
                        ...
                        LocalDateTime arrivalDateTime = LocalDateTime.of(startDate.getYear(), startDate.getMonth(), day,
                                hour, minute);
     ...
     * @param durationHours Duration in hours to load blockages for (0 for
     *                      unlimited)
     ...
     * @param startDate    The reference start date/time
     * @param durationDays Duration in days to load maintenance tasks for (0 for
     *                     unlimited)
     * @param maxTasks     Maximum number of tasks to load (0 for unlimited)
     * @return List of MaintenanceTask objects
     */
    public List<Maintenance> loadMaintenanceSchedule(String filePath, LocalDateTime startDate, int durationDays,
            int maxTasks) {
                    ...
                    try {
                        ...
                        switch (shiftStr) {
                            ...
                            case "T3":
                                ...
                                break;
                            default:
                                throw new IllegalArgumentException("Invalid shift: " + shiftStr);
                        }
                        ...
                        switch (incidentTypeStr) {
                            case "TI1":
                                incidentType = IncidentType.TI1;
                                break;
                            case "TI2":
                                incidentType = IncidentType.TI2;
                                break;
                            case "TI3":
                                incidentType = IncidentType.TI3;
                                break;
                            default:
                                throw new IllegalArgumentException("Invalid incident type: " + incidentTypeStr);
                        }
    ...
    /**
     * Helper method to parse a time string in the format ##d##h##m into a
     * LocalDateTime
     * 
    ...
    /**
     * Helper method to check if a time interval overlaps with our reference time
     * window
     * 
     ...
     * @param durationHours  The duration of our reference window in hours (0 for
     *                       unlimited)
